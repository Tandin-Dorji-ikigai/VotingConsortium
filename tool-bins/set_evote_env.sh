...
export ORG_CONTEXT=voting
export ORG_NAME=Evoting
...
# Address of the peer
export CORE_PEER_ADDRESS=evote.voting.com:7051
# Local MSP for the admin - Commands need to be executed as org admin
export CORE_PEER_MSPCONFIGPATH=/workspaces/votingconsortium/config/crypto-config/peerOrganizations/voting.com/users/Admin@voting.com/msp
